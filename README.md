...
| [product-planning](plugins/product-planning) | 1.1.0 | Transform specifications into implementation plans, tasks, and test strategies using SDD patterns | product-development |
...
| [meta-skills](plugins/meta-skills) | 0.5.0 | 7 skills for mastering Claude Code, MCP servers, and agentic workflows — Figma Console + figma-use (170+ tools, clone-first Draft-to-Handoff with convergence protocol, batch scripting, subagent delegation), Sequential Thinking, research MCP, mobile MCP, PAL multi-model, deep reasoning escalation | productivity |
