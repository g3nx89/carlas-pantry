...
| [meta-skills](plugins/meta-skills) | 0.4.0 | 7 skills for mastering Claude Code, MCP servers, and agentic workflows — Figma Console + figma-use (170+ tools, clone-first Draft-to-Handoff with visual fidelity gates), Sequential Thinking, research MCP, mobile MCP, PAL multi-model, deep reasoning escalation | productivity |
