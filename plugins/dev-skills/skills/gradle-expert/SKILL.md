---
name: gradle-expert
description: This skill should be used when the user asks to "fix Gradle build error", "resolve dependency conflict", "configure version catalog", "add dependency to libs.versions.toml", "package desktop app as DMG/MSI/DEB", "optimize build performance", "configure Proguard rules", "fix source set issues", "troubleshoot KMP build", or "fix Compose version mismatch". Provides build optimization, dependency resolution, and multi-module KMP troubleshooting guidance.
