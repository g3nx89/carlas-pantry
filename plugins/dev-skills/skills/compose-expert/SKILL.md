---
name: compose-expert
description: This skill should be used when the user asks to "create a Composable", "share UI components", "use remember or derivedStateOf", "optimize recomposition", "apply @Immutable annotation", "implement Material3 theming", "create custom ImageVector icons", "build shared composables in commonMain", or "decide if UI should be shared or platform-specific". Provides advanced Compose Multiplatform UI patterns for shared composables. Delegates navigation to android-expert/desktop-expert. Complements kotlin-expert for state/annotation details.
