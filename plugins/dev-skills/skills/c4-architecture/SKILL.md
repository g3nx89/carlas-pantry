...
description: This skill should be used when the user asks to "create an architecture diagram", "document the architecture", "create a C4 diagram", "show system context", "create a container diagram", "visualize components", "create a deployment diagram", or needs C4 model documentation at any level (Context, Container, Component, Deployment, Dynamic).
