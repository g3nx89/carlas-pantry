...
description: This skill should be used when the user asks to "use supervisorScope", "implement callbackFlow", "combine multiple Flows", "use flatMapLatest", "handle backpressure", "test coroutines with runTest", "use CoroutineExceptionHandler", "implement shareIn or stateIn", "manage Dispatchers", or "create relay subscription pool". Provides advanced Kotlin coroutines patterns including structured concurrency, Flow operators, channels, and testing. Delegates to kotlin-expert for basic StateFlow/SharedFlow patterns.
