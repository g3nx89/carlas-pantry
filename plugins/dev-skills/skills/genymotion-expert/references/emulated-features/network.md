...
> **Cross-references:** For sensor persistence rules and reset scripts, see `sensor-management.md`. For feature availability, see `index.md`. For network degradation recipe, see `ci-and-recipes.md` Recipe 6. For Baseband MCC/MNC GUI configuration (SIM/operator identity), see `gui-walkthroughs.md`.
