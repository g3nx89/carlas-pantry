...
| `summary-schemas.md` | 107 | YAML schemas for all 6 stage summaries — base fields table + per-stage field tables with type, required/optional, default, producer, consumer |
