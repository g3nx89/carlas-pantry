...
| Section | Recipe | Line |
|---------|--------|-----:|
| **Composition** | Shell Injection (Multi-Region Pages) | 34 |
| | Compose Library Components into Layout | 102 |
| | Design System Bootstrap | 169 |
| **Relocated** | CSS Grid Card Layout | 243 |
| | Proportional Resize Calculator | 341 |
| **Advanced** | Variable Binding to Nodes | 446 |
| | SVG Import and Styling | 534 |
| | Mixed-Style Rich Text | 571 |
| **Full Page** | Settings Page (End-to-End Multi-Call) | 619 |
| **Chaining** | Component Composition Pattern | 953 |
| | Iterative Refinement Pattern | 965 |
| | Design System Bootstrap Pattern | 980 |
| | Handoff Preparation Pattern | 992 |
| | Handoff Naming Audit | 1008 |
| **Variables** | Variable Alias Chain (Semantic Tokens) | 1068 |
| | Effect and LayoutGrid Variable Binding | 1133 |
...
## Relocated Layout & Constraint Recipes

> These recipes were moved from `recipes-foundation.md` to reduce Tier 1 context budget.
