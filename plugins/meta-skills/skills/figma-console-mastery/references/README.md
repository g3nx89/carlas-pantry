...
| `recipes-restructuring.md` | 836 | Restructuring recipes: deep node tree analysis, repeated pattern detection, convert to auto-layout, reparent children, snap spacing, extract component, replace with library instance, variant sets, token binding, batch rename, Socratic question templates | Restructuring a freehand design (Tier 2 — by task) |
