...
| `anti-patterns.md` | 225 | Error catalog, recurring API pattern errors, context and buffer anti-patterns, debugging, hard constraints, rate limiting, performance anti-patterns, idempotency | Debugging or reviewing output |
...
| `workflow-draft-to-handoff.md` | 243 | Draft-to-Handoff workflow: 11 operational rules, session state persistence pattern, 6-phase workflow (Inventory, Component Library, Screen Assembly, Prototype Wiring, Annotations, Validation), error prevention quick reference, fallback protocol | Converting hand-designed drafts into structured handoff pages (Tier 2 — by task) |
...
| `anti-patterns.md` | `plugin-api.md`, `design-rules.md`, `gui-walkthroughs.md`, `figma-use-overview.md`, `workflow-draft-to-handoff.md` |
...
| `workflow-draft-to-handoff.md` | `anti-patterns.md`, `figma-use-overview.md`, `tool-playbook.md` |
