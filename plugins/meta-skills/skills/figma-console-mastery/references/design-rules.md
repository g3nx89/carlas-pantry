...
| 14 | **SHOULD** prefer UI kit components (M3, Apple, SDS) where applicable | Code handoff: UI kit components get automatic Code Connect on Professional+ plans, providing bidirectional design-code links. See also SHOULD #4 for general component reuse. |
