---
# Specify Workflow State v5
# This file tracks the progress of the specify skill workflow
...
#   v4 -> v5 (RTM tracking, requirements inventory)
# See: skills/specify/references/recovery-migration.md
schema_version: 5
...
# RTM Tracking (v5)
rtm_enabled: null                 # true | false | null (null = not yet decided)
...
user_decisions:
  ...
  rtm_enabled: null               # true | false
  rtm_dispositions: []
  # Structure for each RTM disposition:
  # - req_id: "REQ-001"
  #   disposition: "COVERED"       # COVERED | DEFERRED | REMOVED | PENDING_STORY
  #   target: "US-003"             # US-NNN or null
