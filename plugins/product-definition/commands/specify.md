...
The original phase-by-phase implementation has been consolidated into 8 stages. Research phases (1.7, 1.8) are excluded from the skill:
...
| Stage 5: CLI Validation & Design | Phases 5.0, 5.5 (CLI multi-stance evaluation, design-brief, design-supplement) |
...
| Stage 8: Retrospective | (new) KPI report card, transcript analysis, narrative |
