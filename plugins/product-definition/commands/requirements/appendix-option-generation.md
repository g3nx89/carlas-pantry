# Appendix A: Option Generation Reference

> This appendix explains HOW questions, options, pros/cons, and recommendations are generated.
...
+-----------------------------------------------------------------------------+
                              ...
                              DRAFT.md
                                 ...
                                 v
+-----------------------------------------------------------------------------+
|  PHASE 6: PAL ThinkDeep (9 calls) - RUNS FIRST                              |
|  =========================================================================  |
|                                                                             |
|  +-----------------+  +-----------------+  +-----------------+              |
...
+---------------------------------+-------------------------------------------+
                    ...
                    ==============+==============
                                  ...
                                  v
+-----------------------------------------------------------------------------+
|  PHASE 7: MPA Agents (3 parallel) - WITH ThinkDeep Insights                 |
|  =========================================================================  |
|                                                                             |
|  +-----------------+  +-----------------+  +-----------------------------+  |
...
## A.3: Recommendation Scoring Algorithm
...
TOTAL SCORE -> STAR RATING:
   See `$CLAUDE_PLUGIN_ROOT/config/requirements-config.yaml` -> `scoring.star_rating.*`
...
## A.5: ThinkDeep -> Question Priority
