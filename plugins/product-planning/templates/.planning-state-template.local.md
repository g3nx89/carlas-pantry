...
cli:
  ...
  mode: null  # tri | dual | single_gemini | single_codex | single_opencode | disabled
  dispatch_infrastructure:
    script_available: null
    jq_available: null
    python3_available: null
    timeout_cmd: null  # "timeout" | "gtimeout" | "none"
  # Working CLI command templates verified by Phase 1 smoke test.
  # Coordinators use these via CLI_CMD_OVERRIDE env var to avoid broken defaults.
  verified_commands:
    gemini: null
    codex: null
    opencode: null
